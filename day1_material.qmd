...
#       - Make sure that the threads fastqc uses are the sames as the ones requested with --cpus-per-task 4
...
# Hints:    -  You can open HTML files on the server via R-studio file interface 
