...
# Hint: Since you will repeat the step after the quality cleaning
# make a subfolder to store the outputs when analysing the raw data
...
...
#                   replace it with any the folder name that you have used
awk 'BEGIN{OFS="\t"} 
        NR>1 {
